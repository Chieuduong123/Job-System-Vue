<template lang="">
    <div class="max-w-[1300px] mx-auto mt-[150px] max-xl:px-[50px] max-sm:px-[20px]">
        <h1 class="font-semibold text-[20px] max-xl:px-[50px] max-sm:px-[20px] max-sm:text-center">List of favorite jobs</h1>
        ...
        <h1 v-else class="text-gray-500 text-center text-[20px] font-semibold">There are no jobs yet</h1>
    </div>
