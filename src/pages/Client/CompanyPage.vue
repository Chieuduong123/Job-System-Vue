<template lang="">
    <div class="">
        <div class="relative w-full h-[200px] pt-[20px]" style="background-image: url('https://static.topcv.vn/top_lists/4b8ef4660883f68e7a54770b8e7341b4-61b968185df9c.jpg'); background-repeat: no-repeat; background-size: cover;">
            <h1 class="text-center text-white text-[30px] font-semibold px-[20px]">Explore 100,000+ featured companies
            </h1>
        ...
        <h1 class="text-center font-semibold text-[34px] mt-[50px] px-[20px]">LIST OF TOP COMPANIES
        </h1>
